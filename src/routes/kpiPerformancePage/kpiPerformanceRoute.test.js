...
import KpiPerformanceScene from './kpiPerformanceScene'
import {shallow} from 'enzyme'

it('should render', () => {
  const kpiPerformanceScene = shallow(<KpiPerformanceScene />)
  expect(kpiPerformanceScene.length).toBe(1)
})
...
//   const appScene = shallow(<KpiPerformance navigation={{navigate: starsButtonMock}} />)
