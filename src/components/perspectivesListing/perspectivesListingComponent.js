...
export default function PerspectivesList (props) {
  console.log('props', props.perspectivesListing, props.setPerspectivesActionSettings)
                    ...
                    <div className='col-9 float-right col-form-label'>
                      <div className='m-radio-inline'>
                        <label htmlFor='example-email-input' className=''>
                          <input type='radio' name='example_8' value='ComponentType' checked={''} onChange={''} /><span style={{'marginLeft': '10px'}}>Component Type</span>
                          <span />
                        </label>&nbsp;
                        <label htmlFor='example-email-input' className=''>
                          <input type='radio' name='example_8' value='Rejected' checked={''} onChange={''} /><span style={{'marginLeft': '10px'}}>Connection Type</span>
                          <span />
                        </label>
                      </div>
                    </div>
