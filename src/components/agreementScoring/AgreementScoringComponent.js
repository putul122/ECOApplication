...
import styles from './AgreementScoringComponent.scss'

class AgreementScoring extends Component {
  constructor (props) {
    super(props)
  ...
  setDropdownItems = () => {
    ...
    console.log('this.dropdownItemsObjectWithIds', this.dropdownItemsObjectWithIds)
  }
...
export default AgreementScoring
